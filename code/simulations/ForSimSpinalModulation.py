...
class ForSimSpinalModulation(ForwardSimulation,CellsRecording):
	...
	Cells membrane potential overt time are the simulation result.
	"""
	...
	def _end_integration(self,result_name):
		...
		ForwardSimulation._end_integration(self,result_name)
	...
	def raster_plot_MN(self,name="",plot=False):
		if rank==0:
			sizeFactor = 0.5
	...
	def raster_plot(self,name="",plot=False):
		if rank==0:
			sizeFactor = 0.5
			colorMap = plt.cm.gray
			colorMap.set_over("#0792fd")
